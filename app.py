...
df =pd.read_csv(r'C:\Users\Aishwarya\Desktop\Prassu\prasanna\internship\bank_assignment\data\credit_risk_dataset.csv')

scaler = load(open(r'C:\Users\Aishwarya\Desktop\Prassu\prasanna\internship\bank_assignment\models\standard_scaler.pkl','rb'))
ohe =load(open(r'C:\Users\Aishwarya\Desktop\Prassu\prasanna\internship\bank_assignment\models\one_hot_encoding.pkl','rb'))
loan_grade_encoder =load(open(r'C:\Users\Aishwarya\Desktop\Prassu\prasanna\internship\bank_assignment\models\grade.pkl','rb'))
...
rf_classifier = load(open(r'C:\Users\Aishwarya\Desktop\Prassu\prasanna\internship\bank_assignment\models\rf_model.pkl', 'rb'))
